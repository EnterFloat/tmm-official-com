...
const Product = class extends React.Component {
  ...
  render() {
    ...
    if (sanityProduct === null) {
      return (<Container style={{paddingTop: "44px"}}>
    ...
    return (
      <>
      <Jumbotron style={{paddingBottom: "0px", paddingTop: "0px", paddingRight: "0px"}}>
        <Row>
          <Col
            xs={{ span: 12}}
            sm={{ span: 12 }}
            ...
            <Container className={"title-box"} style={{textAlign: "right"}}>
              ...
              <p>
                <Link to={"marketplace/"+ (product.id).toLowerCase() +"/#plans"}><Button style={buttonStyles}>Purchase now</Button></Link>
              </p>
            </Container>
          </Col>
          <Col
          ...
          xl={{ span: 8 }}
          >
          <Carousel indicators={true} style={{width: "100%", height: carouselHeight + "px"}}>
          <Carousel.Item>
            <img 
      ...
      <Container>
        ...
        <Jumbotron style={{background: "#760000", borderRadius: "0px"}}>
          <Row>
            <Col>
              <h2 style={{color: "white", textAlign: "right", marginRight: "100px"}}>Recommendations</h2>
              <Row>
                ...
                return (
                  <Col
                    ...
                    <Card style={{padding: "8px"}}>
                      ...
                      <Card.Text>{review.details}<br></br>
                      <p style={{textAlign: "right", marginBottom: "0px"}}>{review.author}</p>
                      </Card.Text>
                    </Card>
                 </Col>   
                )
          ...
          <Row>
            <Col>
              <h2>Advantages</h2>
              <p style={{whiteSpace: 'pre-wrap'}}>{sanityProduct.advantages}</p>
            </Col>
          </Row>
          ...
          {associatedPlans.map(( plan ) => (
            <>           
              ...
              <Card>
                ...
                <Card.Body>
                  <h5>{plan.amount/100} <span style={{color: "grey"}}> {(plan.currency).toUpperCase()}</span></h5>
